    ...
    <div className=" bg-image bg-cover min-h-screen flex flex-col items-center justify-center ">
      <div className="w-full max-w-md bg-blue-300 bg-opacity-60 rounded-lg p-6">
        ...
        <div className="flex flex-col gap-7">
          ...
          />
          <button
            className="bg-white py-2 text-blue-800 font-bold rounded-xl hover:bg-blue-700 hover:text-white "
        ...
        {error && (
          <p className="text-red-800 text-center font-bold pt-2">{error}</p>
        )}
        {weatherdata && (
